...
(crontab -l 2>/dev/null; echo "@reboot $HOME/escooter-monitoring/raspberry/scripts/lte/lte.sh") | crontab -

# Run the script
/bin/bash $HOME/escooter-monitoring/raspberry/scripts/lte/lte.sh
