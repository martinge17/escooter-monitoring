...
//Check protocol documentation to learn more.
...
pub enum Registers {
   ...
   * Audio/video data transport protocol
    https://www.bluetooth.org/DocMan/handlers/DownloadDoc.ashx?doc_id=260860
   */
  AVDTP
}
...
impl Registers {
  pub fn to_uuid(&self) -> Uuid {
    let uuid = match self {
      Self::UART => "6e400001-b5a3-f393-e0a9-e50e24dcca9e", //Nordic Semi Bluetooth Serial Service https://developer.nordicsemi.com/nRF_Connect_SDK/doc-legacy/1.8.0/nrf/libraries/bluetooth_services/services/nus.html
      Self::TX => "6e400002-b5a3-f393-e0a9-e50e24dcca9e", // Answer read in TX channel of the scooter
      Self::RX => "6e400003-b5a3-f393-e0a9-e50e24dcca9e", //Frames send in RX channel of the scooter
      Self::AUTH => "0000fe95-0000-1000-8000-00805f9b34fb", // Custom service for Xiaomi BLE Authentication
...
impl TryFrom<ValueNotification> for MiCommands {
  type Error = &'static str; //Error as string literal
